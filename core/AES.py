...
def encrypt(data_file, rsa_public_key, sym_key_size):
    ...
    # Encrypts the random session key with the RSA public key
...
def decrypt(data_file, encrypted_key, rsa_private_key):
    ...
    # Unpackages AES nonce and the encrypted data from the file
    ...
    #Decrypts the data using the random session key
